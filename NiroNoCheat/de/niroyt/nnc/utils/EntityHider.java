...
public class EntityHider implements Listener {
    ...
    // Current policy
    protected static Policy policy = Policy.WHITELIST;
     ...
     */
    protected static boolean setVisibility(Player observer, int entityID, boolean visible) {
        switch (policy) {
            case BLACKLIST:
     ...
     */
    public static boolean showEntity(Player observer, Entity entity) {
     ...
     */
    public static boolean hideEntity(Player observer, Entity entity) {
        validate(observer, entity);
